...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// registers gameuserrestcontroller to environment with method get validator
		...
		// creates jersey client builder with name DemoRESTClient and registers it to client controller
